      ...
      <div class="container">
         ...
         <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-centered">
               <a href="index-2.html">
                  <!-- logo  -->
                  <img src="img/mechin4.jpg" style="width: 100px; height: 50px;" class="img-responsive" alt="">
               </a>
            </div>
         </div>
         <!--/navbar-header -->
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="plan">
                     ...
                     <div class="text-center">
                        <a class="btn" <?php if ($a == 0) { ?> onclick="alert('Layanan tidak tersedia saat ini')" <?php } else {
                                                                                                                  echo " href=\"order.php\"";
                                                                                                               }  ?>>Order</a>
                     </div>
                     <!-- /text-center -->
   ...
   <footer>
      ...
      <div class="container">
         <div class="col-md-4 text-center">
            <!-- Footer logo -->
            <img src="img/mechin4.jpg" style="width: 200px; height: 130px;" alt="" class="center-block img-responsive">
         </div>
         <!-- /.col-md-4 -->
